...
path = r"C:\Users\shiva\OneDrive\Desktop\computer vision\im0.jpg"
path2 = r"C:\Users\shiva\OneDrive\Desktop\computer vision\im1.jpg"
...
def TakeImages():
    ...
    if(is_number(Id) and name.isalpha()):
        ...
        harcascadePath = r"C:\Users\shiva\OneDrive\Desktop\computer vision\haarcascade_frontalface_default.xml"
        ...
        while(True):
            ...
            for (x, y, w, h) in faces:
                ...
                cv2.imwrite(r"C:\Users\shiva\OneDrive\Desktop\computer vision\dataset\ "+name + "."+Id + '.' +
        ...
        row = [Id, name]
        with open(r'C:\Users\shiva\OneDrive\Desktop\computer vision\EmployeeDetails\EmployeeDetails.csv', 'a+') as csvFile:
...
def TrainImages():
    ...
    harcascadePath = r"C:\Users\shiva\OneDrive\Desktop\computer vision\haarcascade_frontalface_default.xml"
    detector = cv2.CascadeClassifier(harcascadePath)
    faces, Id = getImagesAndLabels(r"C:\Users\shiva\OneDrive\Desktop\computer vision\dataset")
    recognizer.train(faces, np.array(Id))
    recognizer.save(r"C:\Users\shiva\OneDrive\Desktop\computer vision\trainfile/trainer.yml")
...
def TrackImages():
    ...
    # recognizer=cv2.createLBPHFaceRecognizer()
    recognizer = cv2.face_LBPHFaceRecognizer.create()
    recognizer.read(r"C:\Users\shiva\OneDrive\Desktop\computer vision\trainFile/trainer.yml")
    harcascadePath = r"C:\Users\shiva\OneDrive\Desktop\computer vision\haarcascade_frontalface_default.xml"
    faceCascade = cv2.CascadeClassifier(harcascadePath)
    df = pd.read_csv(r"C:\Users\shiva\OneDrive\Desktop\computer vision\EmployeeDetails\EmployeeDetails.csv")
    cam = cv2.VideoCapture(1)
    ...
    while True:
        ...
        for(x, y, w, h) in faces:
            ...
            if(conf < 50):
                ...
                tt = str(Id)
            if(conf > 75):
                noOfFile = len(os.listdir(r"C:\Users\shiva\OneDrive\Desktop\computer vision\ImagesUnknown"))+1
                cv2.imwrite(r"C:\Users\shiva\OneDrive\Desktop\computer vision\ImagesUnknown\Image"+str(noOfFile) +
                            ".jpg", im[y:y+h, x:x+w])
    ...
    fileName = r"C:\Users\shiva\OneDrive\Desktop\computer vision\Attendance\Attendance_"+date+"_"+Hour+"-"+Minute+"-"+Second+".csv"
